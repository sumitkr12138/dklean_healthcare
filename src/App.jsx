...
import StaticBookAppointment2 from "./Components/StaticBookAppointment2";
import HealthPackages from "./Components/HealthPackages";
import StaticDonateSection from "./Components/StaticDonateSection";

import DelhiServices from "./Components/DelhiServices";
...
import ThankYouPage from "./Components/Donations/ThankYouPage";
    ...
    <Router>
      <div className="h-full">
        ...
        <Routes>
            ...
            element={
              loggedInUser.isloggedIn ? (
                <>
                  ...
                  <Navbar />
                  <Dates />{" "}
                  {/* the calendar and time slots - in timeslots only two componets Universalpatieent, FinalSelect */}
                  {/* <AllAppointment /> */}
                </>
              ) : (
                <>
          ...
          <Route
            path="/staticbookappointment"
            element={<StaticBookAppointment />}
          />
          <Route
            path="/staticbookappointment2"
            element={<StaticBookAppointment2 />}
          />
