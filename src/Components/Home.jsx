        ...
        <div className="lg:w-2/5 md:w-3/5 sm:w-4/5 w-full text-center space-y-4 px-4">
          ...
          <div className="flex justify-center gap-2 sm:gap-4 mt-6 animate-fade-in-up delay-[800ms] flex-wrap">
            <button
              ...
              className="bg-[#6d0101] text-white px-4 sm:px-6 py-3 sm:py-4 rounded-md text-xs sm:text-sm font-semibold hover:bg-black hover:scale-105 transition duration-300"
            >
              Book An Appointment
            </button>
            <button
              ...
              className="bg-transparent backdrop-blur-md border border-white text-white px-4 sm:px-6 py-3 sm:py-4 rounded-md text-xs sm:text-sm font-semibold hover:bg-white hover:text-black hover:scale-105 transition duration-300"
            >
              Our Packages
            </button>
          </div>
