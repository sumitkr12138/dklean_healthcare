            ...
            onClick={() => {
              ...
              setTimeout(() => {
                ...
                if (el) {
                  ...
                  window.location.href = "/staticbookappointment";
                }
              }, 300);
            }}
          >
        ...
        <div className="hidden lg:flex gap-6 items-center">
          ...
          <button
            onClick={() => {
              ...
              else window.location.href = "/home#book-appointment";
            }}
            className="bg-[#6d0101] text-white font-semibold px-4 py-2 rounded-md hover:bg-black transition duration-300"
          >
            Book Appointment
          </button>
        </div>
