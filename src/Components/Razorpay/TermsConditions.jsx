    ...
    <div className="min-h-screen bg-gray-100 p-8">
      <header className="text-center mb-12 animate__animated animate__fadeInDown">
        <h1 className="text-4xl font-bold text-blue-600 flex items-center justify-center gap-3">
          <FaInfoCircle className="text-blue-500" /> Terms and Conditions for
          Receiving Payment – Dklean Health Care Public Charitable Trust
        </h1>
      ...
      <main className="max-w-4xl mx-auto bg-white p-6 rounded-lg shadow-lg animate__animated animate__fadeInUp space-y-6">
          ...
          text={
            <>
              ...
              <ul className="list-disc list-inside mt-2 space-y-1">
                <li>
                  Donations (voluntary, with or without specific purposes)
                </li>
                <li>
                  Grants or Sponsorships (based on formal agreement or MOU)
                </li>
                <li>
                  Project-Based Funding (subject to specific deliverables)
                </li>
              </ul>
            </>
          }
        ...
        <Section
          ...
          text={
            <>
              <p>
                Upon receipt of the payment, the NGO will issue an official
                receipt to the donor within 7 working days.
              </p>
              <p className="mt-2">
                Donations eligible for tax exemption under Section 80G or other
                applicable law will be provided the necessary certificates.
              </p>
            </>
          }
        />
        ...
        <Section
          ...
          text={
            <>
              ...
              <p className="mt-2">
                In exceptional cases (such as duplicate transactions), refunds
                may be processed upon written request within 15 days of payment,
          ...
          text={
            <>
              ...
              <ul className="list-disc list-inside mt-2 space-y-1">
                ...
                <li>UPI / Wallets</li>
                <li>
                  Cheques or Demand Drafts (in favor of “Dklean Health Care
                  Public Charitable Trust”)
                </li>
                <li>
                  Online payment through our official website/payment gateway
                </li>
              </ul>
            </>
          }
        ...
        <Section
          ...
          text={
            <>
              <p>
                Donor information will be kept confidential and used solely for
                communication and statutory reporting.
              </p>
              <p className="mt-2">
                We will not share donor information with third parties without
                prior consent.
              </p>
            </>
          }
...
{/* 
        <div className="mt-10 flex justify-center">
          <img
            src="../../../src/assets/termsandcondition.jfif"
            alt="Terms and Conditions"
            className="w-2/3 animate__animated animate__zoomIn"
          />
        </div> */}
      </main>
    </div>
